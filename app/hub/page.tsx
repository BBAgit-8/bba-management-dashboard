    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-950 via-purple-900 to-purple-800 px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-white">BBA Team Hub</h1>
          <p className="text-sm text-white/60">Sign in to view your clients</p>
        </div>
        ...
        <p className="text-center text-xs text-white/40">BBA Bookkeeping · Team access only</p>
      </div>
    </div>
  )
}
